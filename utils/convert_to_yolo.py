...
data_path = '../data/data_splited'
target_path = os.path.join(data_path, 'data_yolo')
...
os.makedirs(target_path + '/images/valid', exist_ok=True)
os.makedirs(target_path + '/labels/valid', exist_ok=True)
os.makedirs(target_path + '/images/test', exist_ok=True)
...
with open(os.path.join(target_path, 'endoscopy.yaml'), 'w') as outfile:
